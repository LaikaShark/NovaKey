 ...
 * accent / contrast), plus a 3D checkbox to the preview's live
 * {@link Model}. Each picker change updates the model's
...
public class StylePreferenceActivity extends AbstractPreferenceActivity {
     ...
     * {@code mModel.getTheme()} and refreshes the preview. The 3D
     * checkbox toggles
     ...
     * the in-memory theme to disk via {@link ThemeLoader#save}. Only
     * runs on positive exit (FAB click); cancel paths leave the
